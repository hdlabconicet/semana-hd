      ...
      <div className="lg:flex lg:flex-row lg:gap-8 items-center w-11/12 lg:w-10/12">
        ...
        <div className="lg:w-1/2">
          ...
          <div className="question">
            ...
            <p>Te ofrecemos nuestra plataforma donde se verá tu evento desde un calendario con fecha, hora y todos los datos que aportes. Te ofrecemos dar difusión a tu evento a través de las redes sociales de la RedHD, la AAHD y la RedCo. También te ofrecemos ser parte del proyecto SemanaHD, ya que todos los calendarios se guardan en la zona Archivo para que quede constancia de tu participación.</p>
          </div>
